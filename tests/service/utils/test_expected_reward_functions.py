...
def test_内積が大きいペアほど上限値に近く小さいペアほど下限値に近い期待報酬関数になる() -> (
    None
):
    # Arrange
    n_rounds = 2
...
def test_逆順を指定する場合は内積が小さいペアほど上限値に近く大きいペアほど下限値に近い期待報酬関数になる() -> (
    None
):
    # Arrange
    n_rounds = 2
